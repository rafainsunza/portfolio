...
import DownloadPdf from "../download-cv/download-pdf";
          ...
          <div className="cv__side-content__item">
            ...
            <ul className="cv__side-content__list">
              <li className="cv__side-content__list-item spaced">
                ...
                <a className="cv__side-content__list-item__text" href="tel:+31649119618">
                  06 - 49 11 96 18
                </a>
              </li>
              <li className="cv__side-content__list-item spaced">
                <FontAwesomeIcon icon={faEnvelope} />
                <a className="cv__side-content__list-item__text" href="mailto:rafainsunza@outlook.com">
                  rafainsunza@outlook.com
                </a>
              </li>
              <li className="cv__side-content__list-item spaced">
                <FontAwesomeIcon icon={faLocationDot} />
                <p className="cv__side-content__list-item__text">{translation("cv.side-content.location")}</p>
              </li>
              <li className="cv__side-content__list-item spaced">
                <FontAwesomeIcon icon={faGithub} />
                <a
                  className="cv__side-content__list-item__text"
